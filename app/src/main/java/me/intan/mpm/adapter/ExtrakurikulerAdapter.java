...
public class ExtrakurikulerAdapter extends BaseAdapter {
    private final Activity activity;
    private LayoutInflater inflater;
    private final List<ExtrakurikulerData> newsItems;
    private ImageLoader imageLoader;

    public ExtrakurikulerAdapter(Activity activity, List<ExtrakurikulerData> newsItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.list_row_extrakurikuler, null);
        ...
        ExtrakurikulerData news = newsItems.get(position);
