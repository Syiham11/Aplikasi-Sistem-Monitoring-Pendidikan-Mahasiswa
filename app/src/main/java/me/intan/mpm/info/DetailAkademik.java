...
public class DetailAkademik extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private static final String TAG = DetailAkademik.class.getSimpleName();
    ...
    private static final String url_detail 	= ServerInfo.URL + "detail_akademik.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.detail_akademik);
        //noinspection ConstantConditions,ConstantConditions
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setTitle("Detail Informasi Akademik");
    ...
    private void callDetailNews(final String id){
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url_detail, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Log.e(TAG, "Detail Informasi Akademik Error: " + error.getMessage());
                Toast.makeText(DetailAkademik.this,
