...
public class DetailUniversitas extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private static final String TAG = DetailUniversitas.class.getSimpleName();
    ...
    private static final String url_detail 	= ServerInfo.URL + "detail_universitas.php";
    private final String tag_json_obj = "json_obj_req";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.detail_universitas);
        //noinspection ConstantConditions,ConstantConditions,ConstantConditions
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setTitle("Detail Informasi Universitas");
    ...
    private void callDetailNews(final String id){
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url_detail, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Log.e(TAG, "Detail Informasi Universitas Error: " + error.getMessage());
                Toast.makeText(DetailUniversitas.this,
