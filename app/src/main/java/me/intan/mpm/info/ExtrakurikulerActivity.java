...
import me.intan.mpm.adapter.ExtrakurikulerAdapter;
import me.intan.mpm.data.ExtrakurikulerData;
import me.intan.mpm.main.AppController;


public class ExtrakurikulerActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {

    private ListView list;
    private SwipeRefreshLayout swipe;
    private final List<ExtrakurikulerData> newsList = new ArrayList<>();

    private static final String TAG = ExtrakurikulerActivity.class.getSimpleName();

    private int offSet = 0;

    private int no;

    private ExtrakurikulerAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new Intent(ExtrakurikulerActivity.this, DetailExtrakurikuler.class);
                intent.putExtra(TAG_ID, newsList.get(position).getId());
                startActivity(intent);
            }
        });

        adapter = new ExtrakurikulerAdapter(ExtrakurikulerActivity.this, newsList);
    ...
    private void callNews(int page){
        ...
        String url_list = ServerInfo.URL + "extra.php?offset=";
                        ...
                        if (response.length() > 0) {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                try {
                                    ...
                                    ExtrakurikulerData news = new ExtrakurikulerData();
