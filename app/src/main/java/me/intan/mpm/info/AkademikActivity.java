...
import me.intan.mpm.adapter.AkademikAdapter;
import me.intan.mpm.data.AkademikData;
import me.intan.mpm.main.AppController;


public class AkademikActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {

    private ListView list;
    private SwipeRefreshLayout swipe;
    private final List<AkademikData> newsList = new ArrayList<>();

    private static final String TAG = AkademikActivity.class.getSimpleName();

    private int offSet = 0;

    private int no;

    private AkademikAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  setTitle("List Informasi Akademik");
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new Intent(AkademikActivity.this, DetailAkademik.class);
                intent.putExtra(TAG_ID, newsList.get(position).getId());
                startActivity(intent);
            }
        });

        adapter = new AkademikAdapter(AkademikActivity.this, newsList);
    ...
    private void callNews(int page){
        ...
        String url_list = ServerInfo.URL + "akademik.php?offset=";
                        ...
                        if (response.length() > 0) {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                try {
                                    ...
                                    AkademikData news = new AkademikData();
